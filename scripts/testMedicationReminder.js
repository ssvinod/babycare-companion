...
import { getTodaysMedications } from '../src/services/medicationReminderService.js';
// --------------------------------------------------
...
console.table(
    today.map((m) => ({
        ...
        completedDate: m.completedDate ? shortDate(m.completedDate) : null,
    }))
);
// --------------------------------------------------
...
// --------------------------------------------------
if (today.length) {
    completeMedication(today[0].id, 'baby');
}
// --------------------------------------------------
