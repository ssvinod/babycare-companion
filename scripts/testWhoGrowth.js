...
console.table({
    Weight: calculateGrowth('weightForAge', child, record, record.weight),

    Length: calculateGrowth('lengthForAge', child, record, record.length),

    HeadCircumference: calculateGrowth(
        'headCircumference',
        child,
        record,
