        ...
        chronologicalGrowths
          ...
          .map(
            growth => ({
              ...
              value:
                growth.headCircumference as number,
            })
          ),
      [chronologicalGrowths]
    );
