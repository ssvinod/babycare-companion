...
export default function ProfileScreen() {
  ...
  const deleteBabyProfile =
    useBabyStore(
      state =>
        state.deleteBabyProfile
    );
  const [
    deleting,
    setDeleting,
  ...
  return (
    <ScreenLayout>
      ...
      >
        ...
        >
          Helping parents keep every
          important health record,
          milestone, and vaccination
          in one trusted place—from
      ...
      >
        ...
        <ProfileRow
          ...
          subtitle="Medication and vaccination notification controls"
          disabled
          showArrow={false}
        />
      </View>
      ...
      <Pressable
        ...
        style={({ pressed }) => [
          styles.deleteRow,
          pressed &&
          styles.deleteRowPressed,
          deleting &&
          styles.deleteRowDisabled,
        ]}
      >
        <View
          style={
