...
export default function SetupProfileScreen() {
    ...
    async function save() {
        ...
        if (!birthDate) {
            Alert.alert('Date of birth required', 'Enter a valid date using DD-MM-YYYY.');
            return;
        }
        const selectedDate = new Date(`${birthDate}T00:00:00`);
        if (Number.isNaN(selectedDate.getTime())) {
            Alert.alert('Invalid date of birth', 'Enter a valid date using DD-MM-YYYY.');
            return;
        }
        ...
        if (!gender) {
            Alert.alert('Gender required', 'Please select Boy or Girl.');
            return;
        }
        const parsedWeight = weight.trim() === '' ? undefined : Number(weight);
        const parsedHeight = height.trim() === '' ? undefined : Number(height);
        if (
        ...
        if (
            ...
            Alert.alert('Invalid height', 'Enter a valid height or leave it blank.');
            return;
        }
        try {
            setSaving(true);
            ...
            Alert.alert('Unable to create profile', 'Please try again.');
        } finally {
            setSaving(false);
        }
    }
                ...
                >
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.subtitle}>
                            Add the basic details to begin tracking health, growth and
                            care.
                        </Text>
                        ...
                        <View style={styles.genderRow}>
                            ...
                            >
                                ...
                                <Text
                                    style={[
                                        styles.genderText,
                                        gender === 'boy' && styles.selectedGenderText,
                                    ]}
                                >
                                    Boy
                                </Text>
                            ...
                            >
                                ...
                                <Text
                                    style={[
                                        styles.genderText,
                                        gender === 'girl' && styles.selectedGenderText,
                                    ]}
                                >
                                    Girl
                                </Text>
                        ...
                        <Text style={styles.helper}>
                            Enter the date as DD-MM-YYYY. Hyphens are added automatically.
                        </Text>
                    ...
                    <Text style={styles.privacyNote}>
                        Your baby's information is stored locally on this device.
                    </Text>
                </ScrollView>
            </KeyboardAvoidingView>
        </SafeAreaView>
