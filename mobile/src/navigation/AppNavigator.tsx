            ...
            >
                {!baby ? (
                    ...
                    <>
                        ...
                        />
                        <Stack.Screen name="FeedingRecords" component={FeedingScreen} />
                        <Stack.Screen name="AddFeeding" component={AddFeedingScreen} />
                        <Stack.Screen name="AddGrowth" component={AddGrowthScreen} />
                        <Stack.Screen name="EditGrowth" component={EditGrowthScreen} />
                        <Stack.Screen name="GrowthHistory" component={GrowthScreen} />
                        <Stack.Screen name="SleepDetails" component={SleepScreen} />
                        <Stack.Screen
