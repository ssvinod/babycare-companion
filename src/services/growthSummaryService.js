export function createGrowthSummary(child, analysis, trend, alerts) {
    ...
    return {
        child: child.name,
        ageDays: child.getAgeOnDate(latest?.date ?? new Date()),
        ...
        lengthPercentile: latest?.lengthPercentile ?? null,
        lengthStatus: latest?.lengthStatus ?? null,
        headCircumference: latest?.headCircumference ?? null,
        headCircumferencePercentile: latest?.headCircumferencePercentile ?? null,
        headCircumferenceStatus: latest?.headCircumferenceStatus ?? null,
        trend: trend.trend,
